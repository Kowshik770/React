...
export default class UpdateEmployeeDetails extends Component {
    ...
    UpdateEmployee(e)
    {
        ...
        let url="http://localhost:22452/api/Employee/1";
        axios.put(url,{
           /* "employeeid": 1,
            "employeeName": "Srishitha",
            "employeeEmail": "SrishithaR@gmail.com",
            "employeePassword": "54321",
            "employeeMobileNumber": 87956401,
            "dateOfjoin": "2022-09-14T00:00:00",
            "department": "dev",
            "managerId": 1*/
  ...
  render() {
    ...
    return (
        ...
        <tr>
            <td></td>
            <td>
                <button type="button" onClick={this.UpdateEmployee}>Insert</button>
