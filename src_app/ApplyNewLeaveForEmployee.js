    ...
    return (
      <><div>CreateLeave</div><table className='t' border="1" align="center">
            ...
            <tr>
                ...
                <td><input type="date" name="strartDate" onChange={(e) => this.handleChange({ strartDate: e.target.value })}></input> </td>
            </tr>
            <tr>
                <td><label>endDate</label> </td>
                <td><input type="date" name="endDate" onChange={(e) => this.handleChange({endDate: e.target.value })}></input> </td>
            </tr>
            <tr>
